...
# prefix matters — `go build .` at the repo root builds an empty stub.
build:
	CGO_ENABLED=0 go build -trimpath -o bin/astrald ./cmd/astrald
	CGO_ENABLED=0 go build -trimpath -o bin/astral-query ./cmd/astral-query
