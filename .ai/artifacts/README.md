...
Working notes, plans, analysis, research, and session output.

Artifacts are not default context. Load only when:

- user references an artifact
- task continues a specific artifact
